...
?>
    ...
    <h4 style="color:#fff">Hacer venta</h4>
    <h4 style="color:#fff"><strong><div id="nombreclienteVenta"></div></strong></h4>
    <table class="table table-bordered table-hover table-condensed" style="text-align: center;">
    <caption>
        <span style="color:#fff" class="btn btn-success" onclick="crearVenta()"> Generar venta
    ...
    <tr>
        <td style="color:#fff">Total de venta: <?php echo "$".$total; ?></td>
    </tr>
